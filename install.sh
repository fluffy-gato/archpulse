...
read USER
clear
echo "Please pick a version (gnome, suckless, xfce, blank)"
read VER
clear
if [ -z VER ]
then
...
then
 ...
 echo "Done!"
	...
	wget https://raw.githubusercontent.com/trurune/totoro-linux/master/os-release
 	...
 	echo "Efistub setup"
	efibootmgr --create --disk $ROOTPULSE --part 1 --label "Arch Linux :3" --loader /vmlinuz-linux --unicode 'root='$ROOTPULSE' rw initrd=\initramfs-linux.img'	
    echo "Done!"
    clear
